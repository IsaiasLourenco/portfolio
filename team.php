      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu m-0">
              <a href="price.php" class="dropdown-item">Preço</a>
              <a href="feature.php" class="dropdown-item">Habilidades</a>
              <a href="team.php" class="dropdown-item active">Equipe</a>
    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="w-100" src="img/time-1.jpg" alt="Image" />
        ...
        <div class="carousel-item">
          <img class="w-100" src="img/time-2.jpg" alt="Image" />
          <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
            <div class="p-3" style="max-width: 900px">
              <h5 class="text-white text-uppercase mb-3 animated slideInDown">
                E entregamos!!
              ...
              <h1 class="display-1 text-white mb-md-4 animated zoomIn">
                Prazo e qualidade acima da média
              </h1>
              <a href="quote.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Orçamento
                Gratuito</a>
              <a href="contact.php" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">Contato</a>
