    ...
    <div class="row g-5">
      <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
        <div
          ...
          <p class="m-0">
            Nunca deixamos nossos clientes com medo dos hackers ou qualquer
            invasão, nossa qualidade está alinhado com a proteção digital
          </p>
      ...
      <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
        <div
          ...
          <p class="m-0">
            Levantamento de Requisitos e Engenharia Reversa são pontos
            importantes para um projeto excelente desde a base
          </p>
          <a class="btn btn-lg btn-primary rounded" href="">
            <i class="bi bi-arrow-right"></i>
          </a>
      ...
      <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
        <div
          ...
          <p class="m-0">
            Sempre autalizados, trabalhando com as últimas versões de linguagens
            atuais como PHP e JavaScript
          </p>
          <a class="btn btn-lg btn-primary rounded" href="">
            <i class="bi bi-arrow-right"></i>
          </a>
      ...
      <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
        <div
          ...
          <p class="m-0">
            Hoje em dia nossa rede empresarial ou doméstica tem novos dispositivos
            para trocar informações em tempo real com os PC's, e linguagens como
            Ionic e React são o alicerce para esse exchange
          </p>
          <a class="btn btn-lg btn-primary rounded" href="">
            <i class="bi bi-arrow-right"></i>
          </a>
      ...
      <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
        <div
          ...
          <p class="m-0">
            Otimização para motores de busca ou para mecanismos de busca é o conjunto de estratégias para
            potencializar e melhorar o posicionamento de um site nas páginas de resultados
          </p>
          <a class="btn btn-lg btn-primary rounded" href="">
            <i class="bi bi-arrow-right"></i>
          </a>
