        ...
        <div class="navbar-nav ms-auto py-0">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu m-0">
              ...
              <a href="quote.php" class="dropdown-item active">Orçamento Gratuito</a>
            </div>
          </div>
    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="w-100" src="img/quote-1.jpg" alt="Image" />
          <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
            <div class="p-3" style="max-width: 900px">
              ...
              <h1 class="display-1 text-white mb-md-4 animated zoomIn">
                Estamos esperando seu contato ou visita
              </h1>
        ...
        <div class="carousel-item">
          <img class="w-100" src="img/quote-2.jpg" alt="Image" />
          <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
            <div class="p-3" style="max-width: 900px">
              <h5 class="text-white text-uppercase mb-3 animated slideInDown">
                Conheça nossos entregáveis
              </h5>
              <h1 class="display-1 text-white mb-md-4 animated zoomIn">
                Softwares para gestão da sua empresa
              </h1>
              <a href="quote.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Orçamento
                Gratuito</a>
              <a href="contact.php" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">Contato</a>
