...
<head>
  ...
  <link href="css/isaias.css" rel="stylesheet" />
    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="w-100" src="img/prod-1.jpg" alt="Image" />
        ...
        <div class="carousel-item">
          <img class="w-100" src="img/prod-2.jpg" alt="Image" />
          <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
            <div class="p-3" style="max-width: 900px">
              <h1 class="display-4 text-white animated zoomIn">
        ...
        <div class="modal-body d-flex align-items-center justify-content-center">
          <div class="input-group" style="max-width: 600px">
            <input type="text" class="form-control bg-transparent border-primary p-3"
              placeholder="Digite a palavra que quer achar" />
      ...
      <div class="row g-0">
        <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
          <div class="bg-light rounded">
            <div class="border-bottom py-4 px-5 mb-4">
              <h4 class="text-secondary mb-1">Aplicativos</h4>
        ...
        <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
          <div class="bg-white rounded shadow position-relative" style="z-index: 1">
            <div class="border-bottom py-4 px-5 mb-4">
              <h4 class="text-secondary mb-1">Softwares</h4>
        ...
        <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
          <div class="bg-light rounded">
            <div class="border-bottom py-4 px-5 mb-4">
              <h4 class="text-secondary mb-1">Sites</h4>
          ...
          <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
            <div class="team-item bg-light rounded overflow-hidden">
              <div class="team-img position-relative overflow-hidden">
                <img class="img-fluid w-100" src="img/eu II.png" alt="" />
                <div class="team-social">
                  <a
                    class="btn btn-lg btn-primary btn-lg-square rounded"
                    target="_blank"
                    href="https://www.youtube.com/channel/UCIOJJZ2iVCtQ7xrioK9XUTA"
                    ><i class="fab fa-youtube fw-normal"></i
                  ></a>
                  <a
                    class="btn btn-lg btn-primary btn-lg-square rounded"
                    target="_blank"
                    href="https://www.facebook.com/NewProfileIsaiasLourenco/"
                    ><i class="fab fa-facebook-f fw-normal"></i
                  ></a>
                  <a
                    class="btn btn-lg btn-primary btn-lg-square rounded"
                    target="_blank"
                    href="https://www.instagram.com/isaiaslourenco3/"
                    ><i class="fab fa-instagram fw-normal"></i
                  ></a>
                  <a
                    class="btn btn-lg btn-primary btn-lg-square rounded"
                    target="_blank"
                    href="https://www.linkedin.com/in/isaias-louren%C3%A7o-5265b425a/"
              ...
              <div class="text-center py-4">
                ...
                <p class="text-uppercase m-0">Gerente de Projetos</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
            <div class="team-item bg-light rounded overflow-hidden">
              ...
              <div class="text-center py-4">
                <h4 class="text-primary">Isaias Lourenço</h4>
                <p class="text-uppercase m-0">Quality Assurance</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
          ...
          <div class="row gx-5">
            <div class="col-lg-4 col-md-12 pt-5 mb-5">
              ...
              <div class="d-flex mb-2">
                ...
                <p class="mb-0">
                  Rua Mococa, 880, Jardim Itacolomy, Mogi Guaçu/SP
                </p>
              </div>
              <div class="d-flex mb-2">
                <i class="bi bi-envelope-open text-primary me-2"></i>
                <p class="mb-0">isaias@vetor256.com</p>
              </div>
              <div class="d-flex mb-2">
                <i class="bi bi-telephone text-primary me-2"></i>
                <p class="mb-0">(19) 99674 5466</p>
              </div>
              <div class="d-flex mt-4">
                <a class="btn btn-primary btn-square me-2" target="_blank"
                  href="https://www.youtube.com/channel/UCIOJJZ2iVCtQ7xrioK9XUTA"><i
                    class="fab fa-youtube fw-normal"></i></a>
                <a class="btn btn-primary btn-square me-2" target="_blank"
                  href="https://www.facebook.com/joseisaiaslourenco/"><i class="fab fa-facebook-f fw-normal"></i></a>
                <a class="btn btn-primary btn-square me-2" target="_blank"
                  href="https://www.linkedin.com/in/isaias-louren%C3%A7o-5265b425a/"><i
                    class="fab fa-linkedin-in fw-normal"></i></a>
                <a class="btn btn-primary btn-square" target="_blank"
                  href="https://www.instagram.com/isaiaslourenco3/"><i class="fab fa-instagram fw-normal"></i></a>
              </div>
            </div>
            <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
              ...
              <div class="link-animated d-flex flex-column justify-content-start">
                ...
                <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Conheça
                  nosso Time</a>
                <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Últimas
                  do Blog</a>
      ...
      <div class="row justify-content-end">
        <div class="col-lg-8 col-md-6">
          <div class="d-flex align-items-center justify-content-center" style="height: 75px">
            <p class="mb-0">
              &copy;
              <a class="text-white border-bottom" href="index.html">Vetor256</a>. Todos os direitos reservados.

              <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
              Desenvolvido por
              <a class="text-white border-bottom" href="index.html">Vetor256.</a>
            </p>
          </div>
        </div>
      </div>
